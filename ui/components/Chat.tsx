...
// import ReactMarkdown from "react-markdown";
// import { SeatMap } from "./seat-map";
// import { BusinessForm, BusinessFormData } from "./business-form";
// import { LogOut } from "lucide-react";
...
//   const handleBusinessFormSubmit = useCallback(
//     (businessData: BusinessFormData) => {
//       setShowBusinessForm(false);
      
//       // Format the business data as a message
//       const businessMessage = `I want to add my business with the following details:
// Company Name: ${businessData.companyName}
// Industry Sector: ${businessData.industrySector}
// Sub-Sector: ${businessData.subSector}
// Location: ${businessData.location}
// Position Title: ${businessData.positionTitle}
// Legal Structure: ${businessData.legalStructure}
// Establishment Year: ${businessData.establishmentYear}
// Products/Services: ${businessData.productsOrServices}
// Brief Description: ${businessData.briefDescription}${businessData.web ? `\nWebsite: ${businessData.web}` : ''}`;
      
//       onSendMessage(businessMessage);
//     },
//     [onSendMessage]
//   );

//   const handleBusinessFormCancel = useCallback(() => {
//     setShowBusinessForm(false);
//   }, []);
...
//               {msg.role === "user" ? (
//                 <div className="ml-4 rounded-[16px] rounded-br-[4px] px-4 py-2 md:ml-24 bg-black text-white font-light max-w-[80%]">
//                   <ReactMarkdown className="chat-message">{msg.content}</ReactMarkdown>
//                 </div>
//               ) : (
//                 <div className="mr-4 rounded-[16px] rounded-bl-[4px] px-4 py-2 md:mr-24 text-zinc-900 bg-[#ECECF1] font-light max-w-[80%]">
//                   <ReactMarkdown className="chat-message">{msg.content}</ReactMarkdown>
...
//         {showBusinessForm && (
//           <div className="flex justify-start mb-5">
//             <div className="mr-4 rounded-[16px] rounded-bl-[4px] md:mr-24 w-full max-w-2xl">
//               <BusinessForm
